...
-- DROP TABLE IF EXISTS public.mailing;
...
-- DROP TABLE IF EXISTS public.tabulation_report_share_range_performance_inner;
-- DROP TABLE IF EXISTS public.tabulation_report_vote_distribution;
...
-- DROP TABLE IF EXISTS public.upload_user_avatar_201_response;
...
-- DROP TYPE IF EXISTS document_display_category;
...
--
-- Table 'create_digital_shareholder_meeting_request' generated from model 'CreateDigitalShareholderMeetingRequest'
--
CREATE TABLE IF NOT EXISTS public.create_digital_shareholder_meeting_request (
    registrant_type create_digital_shareholder_meeting_request_registrant_type NOT NULL,
...
COMMENT ON TABLE create_digital_shareholder_meeting_request IS 'Original model name - CreateDigitalShareholderMeetingRequest.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.registrant_type IS 'Original param name - registrantType.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.first_name IS 'Original param name - firstName.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.last_name IS 'Original param name - lastName.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.email_address IS 'Original param name - emailAddress.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.registration_questions IS 'Original param name - registrationQuestions.';
COMMENT ON COLUMN create_digital_shareholder_meeting_request.minutes_attended_meeting IS 'Original param name - minutesAttendedMeeting.';
...
COMMENT ON COLUMN create_meeting_request.cutoff_date IS 'Original param name - cutoffDate.';
...
--
CREATE TABLE IF NOT EXISTS public.delete_user_avatar_200_response (
    message TEXT DEFAULT NULL
);
COMMENT ON TABLE delete_user_avatar_200_response IS 'Original model name - deleteUserAvatar_200_response.';
...
--
-- Table 'get_user_avatar_url_200_response' generated from model 'getUserAvatarUrlUnderscore200Underscoreresponse'
--
CREATE TABLE IF NOT EXISTS public.get_user_avatar_url_200_response (
    avatar_url TEXT DEFAULT NULL
);
COMMENT ON TABLE get_user_avatar_url_200_response IS 'Original model name - getUserAvatarUrl_200_response.';
COMMENT ON COLUMN get_user_avatar_url_200_response.avatar_url IS 'Public URL of the user&#39;s avatar, null if no avatar set. Original param name - avatarUrl.';
...
--
CREATE TABLE IF NOT EXISTS public.tabulation_report_dtc_vote_status (
    unvoted_shareholders INTEGER DEFAULT NULL,
    unvoted_shares DECIMAL(20, 9) DEFAULT NULL,
    voted_shareholders INTEGER DEFAULT NULL,
    voted_shares DECIMAL(20, 9) DEFAULT NULL,
    grand_total_shareholders INTEGER DEFAULT NULL,
    grand_total_shares DECIMAL(20, 9) DEFAULT NULL
);
COMMENT ON TABLE tabulation_report_dtc_vote_status IS 'DTC/CDS shareholder vote status breakdown. Original model name - TabulationReport_dtcVoteStatus.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.unvoted_shareholders IS 'Original param name - unvotedShareholders.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.unvoted_shares IS 'Original param name - unvotedShares.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.voted_shareholders IS 'Original param name - votedShareholders.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.voted_shares IS 'Original param name - votedShares.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.grand_total_shareholders IS 'Original param name - grandTotalShareholders.';
COMMENT ON COLUMN tabulation_report_dtc_vote_status.grand_total_shares IS 'Original param name - grandTotalShares.';

--
-- Table 'tabulation_report_non_dtc_vote_status' generated from model 'TabulationReportUnderscorenonDtcVoteStatus'
-- Non-DTC shareholder vote status breakdown
--
CREATE TABLE IF NOT EXISTS public.tabulation_report_non_dtc_vote_status (
    unvoted_shareholders INTEGER DEFAULT NULL,
    unvoted_shares DECIMAL(20, 9) DEFAULT NULL,
    print_shareholders INTEGER DEFAULT NULL,
    print_shares DECIMAL(20, 9) DEFAULT NULL,
    ivr_shareholders INTEGER DEFAULT NULL,
    ivr_shares DECIMAL(20, 9) DEFAULT NULL,
    web_shareholders INTEGER DEFAULT NULL,
    web_shares DECIMAL(20, 9) DEFAULT NULL,
    voted_subtotal_shareholders INTEGER DEFAULT NULL,
    voted_subtotal_shares DECIMAL(20, 9) DEFAULT NULL,
    grand_total_shareholders INTEGER DEFAULT NULL,
    grand_total_shares DECIMAL(20, 9) DEFAULT NULL
);
COMMENT ON TABLE tabulation_report_non_dtc_vote_status IS 'Non-DTC shareholder vote status breakdown. Original model name - TabulationReport_nonDtcVoteStatus.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.unvoted_shareholders IS 'Original param name - unvotedShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.unvoted_shares IS 'Original param name - unvotedShares.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.print_shareholders IS 'Original param name - printShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.print_shares IS 'Original param name - printShares.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.ivr_shareholders IS 'Original param name - ivrShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.ivr_shares IS 'Original param name - ivrShares.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.web_shareholders IS 'Original param name - webShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.web_shares IS 'Original param name - webShares.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.voted_subtotal_shareholders IS 'Original param name - votedSubtotalShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.voted_subtotal_shares IS 'Original param name - votedSubtotalShares.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.grand_total_shareholders IS 'Original param name - grandTotalShareholders.';
COMMENT ON COLUMN tabulation_report_non_dtc_vote_status.grand_total_shares IS 'Original param name - grandTotalShares.';

--
-- Table 'tabulation_report_positions_voted' generated from model 'TabulationReportUnderscorepositionsVoted'
-- Positions voted by shareholder type
--
CREATE TABLE IF NOT EXISTS public.tabulation_report_positions_voted (
    voted INTEGER DEFAULT NULL,
    unvoted INTEGER DEFAULT NULL,
    total_shares DECIMAL(20, 9) DEFAULT NULL,
    voted_shares DECIMAL(20, 9) DEFAULT NULL
);
COMMENT ON TABLE tabulation_report_positions_voted IS 'Positions voted by shareholder type. Original model name - TabulationReport_positionsVoted.';
COMMENT ON COLUMN tabulation_report_positions_voted.total_shares IS 'Original param name - totalShares.';
COMMENT ON COLUMN tabulation_report_positions_voted.voted_shares IS 'Original param name - votedShares.';

--
-- Table 'tabulation_report_share_range_performance_inner' generated from model 'TabulationReportUnderscoreshareRangePerformanceUnderscoreinner'
--
CREATE TABLE IF NOT EXISTS public.tabulation_report_share_range_performance_inner (
    range_label TEXT DEFAULT NULL,
    position_count INTEGER DEFAULT NULL,
    total_shares DECIMAL(20, 9) DEFAULT NULL,
    percent_voted DECIMAL(20, 9) DEFAULT NULL
);
COMMENT ON TABLE tabulation_report_share_range_performance_inner IS 'Original model name - TabulationReport_shareRangePerformance_inner.';
COMMENT ON COLUMN tabulation_report_share_range_performance_inner.range_label IS 'Original param name - rangeLabel.';
COMMENT ON COLUMN tabulation_report_share_range_performance_inner.position_count IS 'Original param name - positionCount.';
COMMENT ON COLUMN tabulation_report_share_range_performance_inner.total_shares IS 'Original param name - totalShares.';
COMMENT ON COLUMN tabulation_report_share_range_performance_inner.percent_voted IS 'Original param name - percentVoted.';

--
-- Table 'tabulation_report_vote_distribution' generated from model 'TabulationReportUnderscorevoteDistribution'
-- Overall vote distribution by account type
--
CREATE TABLE IF NOT EXISTS public.tabulation_report_vote_distribution (
    dtc_voted_shares DECIMAL(20, 9) DEFAULT NULL,
    dtc_unvoted_shares DECIMAL(20, 9) DEFAULT NULL,
    non_dtc_voted_shares DECIMAL(20, 9) DEFAULT NULL,
    non_dtc_unvoted_shares DECIMAL(20, 9) DEFAULT NULL
);
COMMENT ON TABLE tabulation_report_vote_distribution IS 'Overall vote distribution by account type. Original model name - TabulationReport_voteDistribution.';
COMMENT ON COLUMN tabulation_report_vote_distribution.dtc_voted_shares IS 'Original param name - dtcVotedShares.';
COMMENT ON COLUMN tabulation_report_vote_distribution.dtc_unvoted_shares IS 'Original param name - dtcUnvotedShares.';
COMMENT ON COLUMN tabulation_report_vote_distribution.non_dtc_voted_shares IS 'Original param name - nonDtcVotedShares.';
COMMENT ON COLUMN tabulation_report_vote_distribution.non_dtc_unvoted_shares IS 'Original param name - nonDtcUnvotedShares.';
...
CREATE TABLE IF NOT EXISTS public.update_meeting_request (
    ...
    distribution_type TEXT DEFAULT NULL,
    transfer_agent TEXT DEFAULT NULL,
    transfer_agent_confirmed BOOLEAN DEFAULT NULL,
    employee_stock_plans TEXT DEFAULT NULL,
    plan_administrator TEXT DEFAULT NULL,
    plan_administrator_contact TEXT DEFAULT NULL,
    plan_administrator_contact_email TEXT DEFAULT NULL,
...
COMMENT ON COLUMN update_meeting_request.cutoff_date IS 'Original param name - cutoffDate.';
...
COMMENT ON COLUMN update_meeting_request.transfer_agent_confirmed IS 'Original param name - transferAgentConfirmed.';
...
COMMENT ON COLUMN update_user_request.avatar_url IS 'URL of the user&#39;s profile photo stored in Supabase Storage';

--
-- Table 'upload_user_avatar_201_response' generated from model 'uploadUserAvatarUnderscore201Underscoreresponse'
--
CREATE TABLE IF NOT EXISTS public.upload_user_avatar_201_response (
    avatar_url TEXT DEFAULT NULL,
    message TEXT DEFAULT NULL
);
COMMENT ON TABLE upload_user_avatar_201_response IS 'Original model name - uploadUserAvatar_201_response.';
COMMENT ON COLUMN upload_user_avatar_201_response.avatar_url IS 'Public URL of the uploaded avatar. Original param name - avatarUrl.';
