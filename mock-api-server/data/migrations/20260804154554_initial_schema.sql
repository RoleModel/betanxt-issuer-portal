...
DROP TYPE IF EXISTS position_sent_by CASCADE;
...
COMMENT ON COLUMN "position".account_email IS 'Email on file for the holder, when known. Null when voting materials were mailed rather than emailed;
