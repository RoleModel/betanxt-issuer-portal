...
const TABULATION_FIXTURE = {
  ...
  proposals: [
    { number: '1', title: 'Election of Directors — Class II', totalShares: 12_500_000, votesFor: 6_021_000, votesAgainst: 420_000, votesAbstain: 401_000, votesNotCast: 5_658_000 },
    { number: '2', title: 'Advisory Vote on Executive Compensation (Say-on-Pay)', totalShares: 12_500_000, votesFor: 5_810_000, votesAgainst: 780_000, votesAbstain: 252_000, votesNotCast: 5_658_000 },
    { number: '3', title: 'Ratification of Independent Registered Public Accounting Firm', totalShares: 12_500_000, votesFor: 6_500_000, votesAgainst: 190_000, votesAbstain: 152_000, votesNotCast: 5_658_000 },
    { number: '4', title: 'Approval of the 2026 Equity Incentive Plan', totalShares: 12_500_000, votesFor: 4_200_000, votesAgainst: 2_100_000, votesAbstain: 542_000, votesNotCast: 5_658_000 },
  ],
}
...
export function EmailPreviewClient() {
  ...
  async function handleSendTest() {
    ...
    try {
      ...
      const data = (await res.json()) as { data?: { id: string }; error?: string; message?: string }
    ...
    >
            ...
            {TEMPLATES.map((t) => (
              <button
                ...
                style={{
                  padding: '5px 14px',
                  borderRadius: '5px',
                  border: template === t.key ? '1.5px solid rgba(255,255,255,0.9)' : '1.5px solid rgba(255,255,255,0.25)',
      ...
      {sendMessage && (
        ...
        >
          ...
          <button
            onClick={() => { setSendStatus('idle'); setSendMessage('') }}
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: statusColor, fontSize: '16px', lineHeight: 1 }}
          >
            ×
          </button>
        </div>
