...
const LOGO_SRC = "https://ik.imagekit.io/dtunrco/_mSrc-hrybp1AhldJl0Fx1TWckGPufa4SLx_nw2YWHg.png";

const BNLogo = () => (
  <Img src={LOGO_SRC} width={119} height={28} alt="BetaNXT" style={{ display: "block" }} />
);
