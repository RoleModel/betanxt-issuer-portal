...
const TransferAgentPDFDocument: React.FC<TransferAgentPDFDocumentProps> = ({
  clientData,
  logoBase64,
}) => {
    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.mainText}>
          ...
          401k and Pilot Plan Shareholder files as of our Proxy Record Date as
          stated below.
        </Text>
...
const generateTransferAgentPDF = async (
  clientData?: ClientData
): Promise<string> => {
