...
test.describe("clientUtils", () => {
  test.describe("getClientLogo", () => {
    test("should return correct logo for exact client name match", () => {
      expect(getClientLogo("The Wendy's Company")).toBe(
        "/logos/wendys_logo.svg.svg"
      );
      expect(getClientLogo("Paycom Software, Inc.")).toBe(
        "/logos/paycom_logo.svg.svg"
      );
      expect(getClientLogo("Woodward, Inc.")).toBe(
        "/logos/woodward_logo.svg.svg"
      );
      expect(getClientLogo("Enliven Therapeutics, Inc.")).toBe(
        "/logos/enliven-logo.svg"
      );
    });

    test("should return correct logo for ticker match", () => {
      expect(getClientLogo(undefined, "WEN")).toBe(
        "/logos/wendys_logo.svg.svg"
      );
      expect(getClientLogo(undefined, "PAYC")).toBe(
        "/logos/paycom_logo.svg.svg"
      );
      expect(getClientLogo(undefined, "WWD")).toBe(
        "/logos/woodward_logo.svg.svg"
      );
    ...
    test("should return correct logo for account code match", () => {
      ...
      expect(getClientLogo(undefined, undefined, "PAYC-2024")).toBe(
        "/logos/paycom_logo.svg.svg"
      );
      expect(getClientLogo(undefined, undefined, "WWD-2024")).toBe(
        "/logos/woodward_logo.svg.svg"
      );
      expect(getClientLogo(undefined, undefined, "ELVN-2024")).toBe(
        "/logos/enliven-logo.svg"
      );
    });
    ...
    test("should return correct logo for partial name match", () => {
      ...
      expect(getClientLogo("paycom software")).toBe(
        "/logos/paycom_logo.svg.svg"
      );
      expect(getClientLogo("WOODWARD INC")).toBe(
        "/logos/woodward_logo.svg.svg"
      );
      expect(getClientLogo("enliven therapeutics")).toBe(
        "/logos/enliven-logo.svg"
      );
    });
