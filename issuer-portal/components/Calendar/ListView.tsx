...
const filterTasks = (tasks: Task[], searchQuery: string, statusFilter: string): Task[] => {
...
export const ListView: React.FC<ListViewProps> = ({
  ...
  const prepareTaskForDisplay = (dbTask: Task): Task => {
    ...
    return {
      ...
      type: ["upload", "signature", "external", "authorize", "approve"].includes(dbTask.type ?? "")
    ...
    <Fade in={loaded} timeout={500}>
      ...
      >
            ...
            {Array.from({ length: 8 }, (_, i) => i + 1).map((phaseNumber: number) => {
              ...
              return (
                <ListItemButton
                  ...
                  sx={{
                    width: "100%",
                    boxShadow: isSelected ? `inset 4px 0px 0px 0px ${phaseColor}` : "none",
        ...
        <Box flex={1} overflow="auto">
          {selectedPhase === "all" ||
          (typeof selectedPhase === "number" && selectedPhase >= 1 && selectedPhase <= 8) ? (
                            ...
                            >
                              ...
                              >
                                ...
                                <Box textAlign={{ xs: "left", md: "right" }}>
                                  ...
                                  <StatusChip status={task.status ?? "INCOMPLETE"} size="small" />
                                </Box>
                              </Box>
                            </Paper>
                          </motion.li>
