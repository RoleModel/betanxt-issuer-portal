...
const fallbackApiBaseUrl = process.env.NEXT_PUBLIC_API_BASE_URL ?? "http://localhost:3001/api";
...
const apiBaseUrl =
  process.env.VERCEL && relatedApiHost ? `${relatedApiHost}/api` : fallbackApiBaseUrl;
