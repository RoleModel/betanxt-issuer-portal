...
// Source: /Users/dallas/Development/betanxt-issuer-portal/mock-api-server/openapi-schema/openapi.yaml
/**
...
export interface paths {
  ...
  "/documents/{documentType}/{versionId}/approve": {
    /** Approve a pending proxy material version */
    post: operations["approveDocumentVersion"];
  };
  "/documents/{documentType}/{approvedVersionId}/replace": {
  ...
  "/documents/{documentType}/history": {
...
export interface components {
  schemas: {
    ...
    /** @enum {string} */
    DocumentStatus: "DRAFT" | "UPLOADED" | "IN_PROGRESS" | "SIGNED" | "AUTHORIZED" | "COMPLETED";
    Account: {
      /** Format: uuid */
      id?: string;
      name?: string;
